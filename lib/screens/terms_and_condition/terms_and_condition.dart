    ...
    return  Scaffold(
      ...
      body: SafeArea(
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomText(text: "terms & \nconditions",size: 26,bold: FontWeight.w400,color: Colors.white,),
                    SizedBox(height: height*0.05,),
                    Text("Last updated on 1/12/2021",style: GoogleFonts.openSans(fontSize: 12,fontWeight: FontWeight.w400,color: Colors.white),),


                    SizedBox(height: height*0.05,),
                    CustomText(text: "Clause 1",size: 20,bold: FontWeight.w400,color: Colors.white,),
                    ...
                    SizedBox(height: height*0.05,),
                    CustomText(text: "Clause 2",size: 20,bold: FontWeight.w400,color: Colors.white,),

                    ConstrainedBox(
                        constraints: BoxConstraints(maxWidth: 280),
                        child: Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra condimentum eget purus in. Consectetur eget id morbi amet amet, in. Ipsum viverra pretium tellus neque. Ullamcorper suspendisse aenean leo pharetra in sit semper et. Amet quam placerat sem. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Viverra condimentum eget purus in. Consectetur eget id morbi amet amet, in. Ipsum viverra pretium tellus neque. Ullamcorper suspendisse aenean leo pharetra in sit semper et. Amet quam placerat sem. Consectetur eget id morbi amet amet, in. Ipsum viverra pretium tellus neque. Ullamcorper suspendisse aenean leo pharetra in sit semper et. Amet quam placerat sem.",style: GoogleFonts.openSans(fontSize: 11,fontWeight: FontWeight.w400,color: Colors.white.withOpacity(0.7)),)),
                  ],
                ),
              ),
        ...
        Column(
          ...
          children: [
            Center(child:  customButton(text: "Accept & Continue"),),
