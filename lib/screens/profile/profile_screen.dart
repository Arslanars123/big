...
import 'package:big_game/screens/profile/edit_profile_screen.dart';
...
class _ProfileScreenState extends State<ProfileScreen> {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        CustomText(text: "edit profile",size: 26,bold: FontWeight.w400,color: Colors.white,),
                     InkWell(
                       onTap: (){
                       ...
                       child: Container(
                         ...
                         decoration: BoxDecoration(
                           image: DecorationImage(image: AssetImage("images/edit.png"),fit: BoxFit.fill)
                         ),
                         child:   CustomText(text: "EDIT",size: 14,bold: FontWeight.w400,color: Colors.white,),
                       ),
                     )
                      ],
                    ),
                    ...
                    Text("Email",style: GoogleFonts.openSans(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.white),),
                    Text("inermeensaif@gmail.com",style: GoogleFonts.openSans(fontSize: 14,fontWeight: FontWeight.w400,color: Colors.white.withOpacity(0.7)),),
                   ...
                   color: Color(0xff01264d),
                      ),
                      child:   CustomText(text: "change password",size: 14,bold: FontWeight.w400,color: Colors.white,),
                    ),
                  ],
                ),
              ),
  ...
  cutomTextFormWidget({required final height,final title,final hintText,final prefixImage}){
    return  Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(title,style: GoogleFonts.openSans(fontSize: 16,color: Colors.white,fontWeight: FontWeight.w700),),
        SizedBox(height: 5,),
        Container(
          height: height,
