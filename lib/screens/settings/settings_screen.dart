              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    CustomText(text: "SETTINGS",size: 26,bold: FontWeight.w400,color: Colors.white,),
                   ...
                   child: Icon(Icons.edit,color: Colors.white,size: 20,),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text("Change Password",style: GoogleFonts.openSans(fontSize: 15,fontWeight: FontWeight.w600,color: Colors.white),),
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Help",style: GoogleFonts.openSans(fontSize: 15,fontWeight: FontWeight.w600,color: Colors.white),),
                          Icon(Icons.keyboard_arrow_right_outlined,color: Colors.white,size: 20,)
                    ...
                    Padding(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text("Logout",style: GoogleFonts.openSans(fontSize: 15,fontWeight: FontWeight.w600,color: Colors.white),),
